...
#'
#' @description
#' Thiamethoxam concentrations in pollen from the Ontario Pollen Monitoring Network ([Pollen monitoring network study](https://data.ontario.ca/en/dataset/pollen-monitoring-network-study)).
#'
#' Variables are:
#' \describe{
